...
_EXTENSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="registered_ext",
            full_name="gnmi_ext.Extension.registered_ext",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gnmi_ext.Extension.master_arbitration",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_REGISTEREDEXTENSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="gnmi_ext.RegisteredExtension.id",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="gnmi_ext.RegisteredExtension.msg",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_MASTERARBITRATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="role",
            full_name="gnmi_ext.MasterArbitration.role",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="election_id",
            full_name="gnmi_ext.MasterArbitration.election_id",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_UINT128 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="high",
            full_name="gnmi_ext.Uint128.high",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="low",
            full_name="gnmi_ext.Uint128.low",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
...
RegisteredExtension = _reflection.GeneratedProtocolMessageType(
    "RegisteredExtension",
    (_message.Message,),
    {
...
MasterArbitration = _reflection.GeneratedProtocolMessageType(
    "MasterArbitration",
    (_message.Message,),
    {
...
Uint128 = _reflection.GeneratedProtocolMessageType(
    "Uint128",
    (_message.Message,),
    {
        "DESCRIPTOR": _UINT128,
